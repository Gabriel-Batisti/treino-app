...
MAPA = {
    "Decline Crunch": ("Decline Crunch", False),
    ...
    "Triceps Rope Pushdown": ("Triceps Pushdown - Rope Attachment", False),
    ...
    "Incline Bench Press (Dumbbell)": ("Incline Dumbbell Press", False),
    "Bicep Curl (Dumbbell)": ("Dumbbell Bicep Curl", False),
    # halter no lugar da polia: mesmo movimento, aparelho diferente
    "Elevação Lateral Unilateral (Cabo)": ("One-Arm Side Laterals", True),
    "Front Raise (Dumbbell)": ("Front Dumbbell Raise", False),
    "Preacher Curl (Barbell)": ("Preacher Curl", False),
    # barra EZ no lugar do halter
    "Skullcrusher (Dumbbell)": ("EZ-Bar Skullcrusher", True),
    "Bench Press (Barbell)": ("Barbell Bench Press - Medium Grip", False),
    "Remada Baixa Triangulo": ("Seated Cable Rows", False),
    "Dumbbell Row": ("One-Arm Dumbbell Row", False),
    "Extensão Lombar (Hiperextensão com Peso)": ("Hyperextensions (Back Extensions)", False),
    "Overhead Press (Dumbbell)": ("Dumbbell Shoulder Press", False),
    "Leg Press 45º (Máquina)": ("Leg Press", False),
    "Deadlift (Barbell)": ("Barbell Deadlift", False),
    "Seated Cable Row - Bar Wide Grip": ("Seated Cable Rows", False),
    ...
    "Bicep Curl (Machine)": ("Machine Bicep Curl", False),
    # landmine row é o mesmo padrão do meadows
    "Meadows Rows (Barbell)": ("Bent Over One-Arm Long Bar Row", True),
    ...
    "Overhead Press (Barbell)": ("Standing Military Press", False),
    "Supino Inclinado (Máquina Smith)": ("Smith Machine Incline Bench Press", False),
    "Overhead Triceps Extension (Cable)": ("Cable Rope Overhead Triceps Extension", False),
